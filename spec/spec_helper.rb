...
require_relative './services/web_mock_stubs'
...
RSpec.configure do |config|
  config.before(:each) do
    ...
    .to_return(status: 200, body: WebmockStubs.mock_name, headers: {})
    stub_request(:get, "https://api.github.com/repos/alexklick/bulk-discount/contributors")
    .to_return(status: 200, body: WebmockStubs.mock_contributors, headers: {})
